...
//! [`action`], the pure game rules in [`rules`], the deposit policy in [`deposit_policy`],
//! and the thin dispatch loop in [`run`]. The account model is the starting point; the
//! staked game lands on top.
//!
