...
//!
//! kaspa-wasm is the locally built `wasm32-core` package at `./kaspa-pkg`
//! (rusty-kaspa @ v2.0.1; npm only ships 0.13.x, so the pkg is vendored).
